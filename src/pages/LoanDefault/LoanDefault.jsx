...
export default function LoanDefault() {
      ...
      <div className="flex items-center justify-between gap-x-5">
        ...
        <form onSubmit={handleSubmit} className="w-[400px]">
          ...
          <div className="mb-5">
            ...
            <p className="mb-2 text-[10px] text-gray-200">Select the applicant's gender.</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <p className="mb-2 text-[10px] text-gray-200">Different loan categories.</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <p className="mb-2 text-[10px] text-gray-200">Is the loan for a business or commercial purpose?</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <p className="mb-2 text-[10px] text-gray-200">CIB: Credit Information Bureau, CRIF: CRIF Credit Solutions, EXP: Experian, EQUI: Equifax.</p>
          </div>
        ...
        <div className="w-[400px]">
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
            />
            <p className="mb-2 text-[10px] text-gray-200">Enter the total loan amount in USD.</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
            />
            <p className="mb-2 text-[10px] text-gray-200">Enter the interest rate percentage.</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
            />
            <p className="mb-2 text-[10px] text-gray-200">Difference between loan rate and benchmark rate.</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
            />
            <p className="mb-2 text-[10px] text-gray-200">Enter the borrower's annual income in USD.</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              required
            />
            <p className="mb-2 text-[10px] text-gray-200">A numerical representation of creditworthiness.</p>
          </div>
